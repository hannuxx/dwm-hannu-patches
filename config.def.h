...
static const char *colors[SchemeLast][3]      = {
	...
	[SchemeSel] =  { col_sel_fg, col_sel_bg,  col_sel_bor  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_norm_fg, "-nf", col_norm_bg, "-sb", col_sel_bg, "-sf", col_sel_fg, NULL };
